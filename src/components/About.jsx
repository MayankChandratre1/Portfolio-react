...
const About = () => {
  return (
    <section id="about" className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-900 via-gray-700 to-gray-600 text-white text-justify">
      <div className="max-w-[50%] text-center flex gap-12">
        <img src={profile} alt="Your Name" className="w-72  rounded-full object-cover object-center mx-auto hover:scale-[1.1] mb-5 transition-all duration-200 linear row-span-2 place-self-center opacity-70 hover:opacity-100 "/>
        <div>
